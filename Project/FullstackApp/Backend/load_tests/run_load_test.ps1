...
#  Utilizare: .\load_tests\run_load_test.ps1
#
#  Generează automat:
#    load_tests/reports/load_report_<timestamp>.md   ← pentru teză
#    load_tests/reports/load_report_<timestamp>.html ← cu grafice
#    load_tests/reports/load_stats_<timestamp>.csv   ← date brute
# ============================================================
