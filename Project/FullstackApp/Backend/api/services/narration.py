...
Lecture Narrator
----------------
Receives page JSONs (output from pdf_extraction.py) and generates
lecture narration in the style of a university professor, using Groq.
...
# ---------------------------------------------------------------------------
# Estimare timp orientativ per pagina
# ---------------------------------------------------------------------------
